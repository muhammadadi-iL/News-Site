            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                  ...
                  <?php
                        ...
                        WHERE posts.post_title LIKE '%{$id}%' OR posts.post_keywords LIKE '%{$id}%'
                                    ...
                                    <div class="inner-content clearfix">
                                        ...
                                        <div class="post-information">
                                            ...
                                            <span>
                                                ...
                                                <a href='author.php?search=<?php echo $row['post_author']; ?>'><?php echo $row['username']; ?></a>
                                            </span>
                                            <span>
                        ...
                        $sql1 = "SELECT * FROM posts WHERE posts.post_title LIKE '%{$id}%'";
                        ...
                        if(mysqli_num_rows($result1) > 0){
                           ...
                           if($page > 1){
                               echo '<li><a href="index.php?search='.$id.'&page='.($page - 1).'"><i class="fa fa-angle-double-left" aria-hidden="true"></i></a></li>';
                           }
                           ...
                           for($i = 1; $i <= $total_page; $i++){
                               ...
                               echo'<li class="'.$active.'"><a href="index.php?search='.$id.'&page='.$i.'">'.$i.'</a></li>';
                           }
                           if($total_page > $page){
                               echo '<li><a href="index.php?search='.$id.'&page='.($page + 1).'"><i class="fa fa-angle-double-right" aria-hidden="true"></i></i></a></li>';
                           }
